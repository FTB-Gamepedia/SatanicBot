...
module Variables
  module Constants
    ...
    WIKI_AUTHNAME = ENV['WIKI_AUTHNAME'].freeze
    WIKI_PASSWORD = ENV['WIKI_PASSWORD'].freeze
    X_API_KEY = ENV['X_API_KEY'].freeze
    X_API_SECRET = ENV['X_API_SECRET'].freeze
    X_ACCESS_TOKEN = ENV['X_ACCESS_TOKEN'].freeze
    X_ACCESS_SECRET = ENV['X_ACCESS_SECRET'].freeze
